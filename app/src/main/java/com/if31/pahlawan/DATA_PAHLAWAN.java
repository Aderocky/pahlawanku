...
public class DATA_PAHLAWAN {
    ...
    public static ArrayList<MODEL_PAHLAWAN> ambildatapahlawan(){
        ArrayList<MODEL_PAHLAWAN> dataPahlawan = new ArrayList<>();
        for (String[] varData : data) {
                 MODEL_PAHLAWAN model = new MODEL_PAHLAWAN();
